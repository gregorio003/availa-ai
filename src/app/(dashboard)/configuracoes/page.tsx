...
import { Save, Plus, Trash2, Bot, Clock, CheckCircle, ExternalLink } from 'lucide-react'
      ...
      <div className="space-y-8">
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="text" defaultValue="Lavajato do João"
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Endereço</label>
              <input type="text" defaultValue="Rua das Flores, 123 - São Paulo/SP"
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500" />
            </div>
            <div>
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={addService} className="flex items-center gap-1.5 text-sm text-green-600 hover:text-green-700 font-medium">
          ...
          <div className="space-y-3">
            {DAYS.map(day => (
              <div key={day.key} className="flex items-center gap-4">
                ...
                <input type="time" defaultValue={day.key === 'sun' ? '' : '08:00'} disabled={day.key === 'sun'}
                ...
                <input type="time" defaultValue={day.key === 'sun' ? '' : day.key === 'sat' ? '13:00' : '18:00'} disabled={day.key === 'sun'}
                  className="px-2 py-1.5 border border-gray-200 rounded text-sm focus:outline-none focus:ring-2 focus:ring-green-500 disabled:bg-gray-100 disabled:text-gray-400" />
                {day.key === 'sun' && (
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Duração padrão do slot (minutos)</label>
            ...
            <Suspense fallback={<div className="h-12 bg-gray-50 rounded-lg animate-pulse" />}>
